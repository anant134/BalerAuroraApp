...
public class RentalCardRegistrationFragment extends Fragment implements View.OnClickListener {
    Button btn_rentalcardregscan;
    MainActivity mainactivie;
    ImageView imv_rentalcardregback;
    Bundle bundle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_rentalcardregscan=(Button)view.findViewById(R.id.btn_rentalcardregscan);
        btn_rentalcardregscan.setOnClickListener(this);

        imv_rentalcardregback=view.findViewById(R.id.imv_rentalcardregback);
        imv_rentalcardregback.setOnClickListener(this);

        mainactivie.progressDialog = new ProgressDialog(mainactivie);

        ListView listView = (ListView)view.findViewById(R.id.ls_rentalcardreglist);
            ...
            public void run() {
                ...
                final Runnable mUpdateResults = new Runnable() {
                    public void run() {
                        ...
                        updateUI();
                        btn_rentalcardregscan.performClick();
                    }
                };
                new Thread(new Runnable() {
                    @RequiresApi(api = Build.VERSION_CODES.O)
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_rentalcardregscan:
                Bundle bundle = new Bundle();
                operationData opd=new operationData();
                opd.setFromname("rentalcardregistration");
                Gson gson=new Gson();
                bundle.putString("form", gson.toJson(opd));

                CardReadingFragment cf=new CardReadingFragment();
                cf.setArguments(bundle);
                fragmentTransaction.replace(R.id.container,cf,"rentalcardregistration" );
                fragmentTransaction.commit();
                break;
            case R.id.imv_rentalcardregback:
