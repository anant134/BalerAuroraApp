...
import com.smartech.tour.gigantestourbooking.TouristRegistrationragment;
...
public class TouristAdapter extends RecyclerView.Adapter<TouristAdapter.Viewholder> {
    ...
    public TouristAdapter(Context context, ArrayList<guestInfo> guestInfoArrayList, Fragment fragment){
    ...
    @NotNull
    @Override
    public TouristAdapter.Viewholder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.touristlist_layout, parent, false);
        return new TouristAdapter.Viewholder(view);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull @NotNull TouristAdapter.Viewholder holder, int position) {
       ...
       // holder.rl_tourist.setBackground(R.drawable.buttongridgreen);
        holder.rl_tourist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((TouristRegistrationragment) fragment).callCardreading(model);
            }
        });
    }
