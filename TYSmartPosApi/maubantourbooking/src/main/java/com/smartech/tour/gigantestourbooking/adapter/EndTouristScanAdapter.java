...
import com.smartech.tour.gigantestourbooking.EndTripTouristscanFragment;
...
public class EndTouristScanAdapter extends RecyclerView.Adapter<EndTouristScanAdapter.Viewholder>  {
    private Context context;
    private ArrayList<guestInfo> guestInfoArrayList;
    private Fragment fragment;

    public EndTouristScanAdapter(Context context, ArrayList<guestInfo> guestInfoArrayList,Fragment fragment){
    ...
    @NotNull
    @Override
    public EndTouristScanAdapter.Viewholder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.touristlist_layout, parent, false);
        return new EndTouristScanAdapter.Viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull EndTouristScanAdapter.Viewholder holder, int position) {
        ...
        holder.tv_touristname.setText(model.getName());
        ...
        holder.rl_tourist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               ((EndTripTouristscanFragment) fragment).marktouristarrive(model);
            }
        });
    }
