...
public class ConstantVariables {
    public static final String baseuserltest ="https://balertourism.smartpay.ph/balertourism/balertourismphp/";
    //public static final String baseuserltest ="http://localhost:80/tourbookingphp/";
    public static final String baseuserllive ="https://balertourism.smartpay.ph/balertourism/balertourismphp/";
    ...
    public void setDeviceid(String devicid) {
