                                               ...
                                               if(fm!=null) {
                                                   switch (objoperationData.getFromname()) {
                                                       ...
                                                       case "touristscan":
                                                           ...
                                                           Fragment fragmenttouristscanlog = getFragmentManager().findFragmentByTag("touristscan");
                                                           if (fragmenttouristscanlog != null)
                                                               getFragmentManager().beginTransaction().remove(fragmenttouristscanlog).commit();


                                                           opd.setReceivedata(carddetail);
                                                           bundle.putString("form", gson.toJson(opd));
                                                           TouristManifestFragment tsl = new TouristManifestFragment();
                                                           tsl.setArguments(bundle);
                                                           fragmentTransaction = fm.beginTransaction();
                                                           fragmentTransaction.replace(R.id.container, tsl, "touristscan");
                                                           fragmentTransaction.commit();
        ...
        switch (v.getId()) {
            case R.id.btn_cardreadingback:
                ...
                switch (objoperationData.getFromname()) {
                    ...
                    case "touristscan":
                        fragmentTransaction = fm.beginTransaction();
                        fragmentTransaction.replace(R.id.container, new TouristManifestFragment(), "touristscan");
                        fragmentTransaction.commit();
                        break;
                    case "captainregistration":
                        fragmentTransaction = fm.beginTransaction();
